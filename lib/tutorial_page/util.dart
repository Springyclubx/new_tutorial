...
TargetPositionDefault? getTargetCurrent(
  TargetFocusDefault target, {
  ...
  if (target.keyTarget != null) {
    ...
    try {
      ...
      return TargetPositionDefault(size, offset);
    } catch (e) {
...
abstract class TutorialCoachMarkControllerDefault {
  void next();
  void previous();
  void skip();
}
