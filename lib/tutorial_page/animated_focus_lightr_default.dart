...
class AnimatedFocusLightDefault extends StatefulWidget {
  ...
  AnimatedFocusLightDefaultState createState() => pulseEnable
...
abstract class AnimatedFocusLightDefaultState extends State<AnimatedFocusLightDefault>
  ...
  Widget _getLightPaint(TargetFocusDefault targetFocus) {
  ...
  SizedBox _getSizedPainter(TargetFocusDefault targetFocus) {
    return SizedBox(
...
class AnimatedPulseFocusLightState extends AnimatedFocusLightDefaultState {
